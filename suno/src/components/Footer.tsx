      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center mb-6">
          ...
          <div className="w-full sm:w-1/4 flex justify-center space-x-4 mb-4 sm:mb-0">
            <a href="https://www.instagram.com/nmtsaz" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#f5c242]">
            ...
            <a href="https://twitter.com/nmtsaz" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#f5c242]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
